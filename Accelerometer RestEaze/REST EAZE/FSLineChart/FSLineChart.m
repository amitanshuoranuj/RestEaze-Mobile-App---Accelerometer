...
- (void)setChartData:(NSArray *)chartData
{
    ...
    _items = [NSMutableArray arrayWithArray:chartData];
...
- (void)strokeChart
{
    ...
    if(_fillColor) {
        ...
        if(_axis==0) _fillColor = [UIColor fsDarkBlue];
        else if (_axis==1) _fillColor = [UIColor fsRed];
        else if (_axis==2) _fillColor = [UIColor fsYellow];
        else if (_axis ==3) _fillColor = [UIColor fsOrange];
        else if (_axis==4) _fillColor = [UIColor fsPink];
        else if (_axis==5) _fillColor = [UIColor fsGreen];
...
//        [self.layers addObject:fillLayer];
    ...
    if(_axis==0) _color = [UIColor fsDarkBlue];
    else if (_axis==1) _color = [UIColor fsRed];
    else if (_axis==2) _color = [UIColor fsYellow];
    else if (_axis ==3) _color = [UIColor fsOrange];
    else if (_axis==4) _color = [UIColor fsPink];
    else if (_axis==5) _color = [UIColor fsGreen];
